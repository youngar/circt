...
namespace {
struct LSPServer {
  LSPServer(HWLServer &server, JSONTransport &transport)
...
void LSPServer::onInitialize(const InitializeParams &params,
  ...
  llvm::json::Object result{
      {{"serverInfo",
        llvm::json::Object{{"name", "hwl-lsp-server"}, {"version", "0.0.1"}}},
...
LogicalResult circt::hwl::runHWLLSPServer(HWLServer &server,
                                            JSONTransport &transport) {
